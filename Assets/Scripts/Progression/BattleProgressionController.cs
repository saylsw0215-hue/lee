...
namespace HeroDefense.Progression
{
    ...
    public sealed class BattleProgressionController:MonoBehaviour
    {
        ...
        private void OnLevelGained(int level){if(hero!=null&&hero.IsAlive)HealingService.Apply(new HealingInfo(hero.gameObject,hero,hero.Health.MaxHealth*.1f,"battle_level_up"));TryShow();}
