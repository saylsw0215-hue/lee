...
namespace HeroDefense.Tests.EditMode
{
    public sealed class ContentDatabaseValidationTests
    {
        ...
        public void DuplicateContentIdReportsTypeIdAndIndex()
        {
            ...
            Assert.That(Validate(RuntimeHeroCatalog.GetHeroes(),new[]{first,second},RuntimeBuildingCatalog.GetAll(),RuntimeStageCatalog.GetAll(),out string reason),Is.False);
        ...
        public void MissingHeroSkillReportsHeroIdAndField()
        {
            ...
            Assert.That(Validate(new[]{hero},RuntimeUnitCatalog.GetAll(),RuntimeBuildingCatalog.GetAll(),RuntimeStageCatalog.GetAll(),out string reason),Is.False);
        ...
        public void MissingSpawnEnemyReportsWaveAndGroupField()
        {
            ...
            Assert.That(Validate(RuntimeHeroCatalog.GetHeroes(),RuntimeUnitCatalog.GetAll(),RuntimeBuildingCatalog.GetAll(),new[]{stage},out string reason),Is.False);
        ...
        public void MissingBuildingProducedUnitReportsBuildingIdAndField()
        {
            ...
            Assert.That(Validate(RuntimeHeroCatalog.GetHeroes(),RuntimeUnitCatalog.GetAll(),new[]{building},RuntimeStageCatalog.GetAll(),out string reason),Is.False);
        ...
        public void InvalidUnitNumberReportsUnitIdAndField()
        {
            ...
            Assert.That(Validate(RuntimeHeroCatalog.GetHeroes(),new[]{unit},RuntimeBuildingCatalog.GetAll(),RuntimeStageCatalog.GetAll(),out string reason),Is.False);
        ...
        private static bool Validate(HeroData[] heroes,UnitData[] units,BuildingData[] buildings,StageData[] stages,out string reason)
        {
            MethodInfo method=typeof(GameContentDatabase).GetMethod("ValidateCatalogs",BindingFlags.NonPublic|BindingFlags.Static);
            Assert.That(method,Is.Not.Null);
            object[] arguments={heroes,units,buildings,stages,null};
            bool result=(bool)method.Invoke(null,arguments);
            reason=(string)arguments[4];
            return result;
        }
    }
}
