...
namespace HeroDefense.Tests
{
    public sealed class Phase2Tests
    {
        ...
        [Test] public void MonsterRewards_AreConfigured() { Assert.AreEqual(10, Resources.Load<UnitData>("UnitData/EnemySlime").RewardGold); Assert.AreEqual(15, Resources.Load<UnitData>("UnitData/EnemyGoblin").RewardGold); }
