...
namespace HeroDefense.Tests
{
    public sealed class Phase4Tests
    {
        ...
        [Test]public void BossDataAndFinalWave_AreValid(){Assert.IsTrue(stage.Waves[9].IsBossWave);Assert.IsTrue(stage.Validate(out _));Assert.AreEqual(1800,RuntimeUnitCatalog.Get("BossGoblinChieftain").MaxHealth);}
